...
*/
    ...
    #define STRUCT_RSEQ_P (129)
    #define STRUCT_FLOCK_P (130)
    #define STRUCT_STATX_P (131)
    #define STRUCT_OPEN_HOW_P (132)
    #define STRUCT_AT_FLAGS_P (133)
    #define STRUCT_MOUNT_ATTR_P (134)
    #define STRUCT_SIGSET_T_P (135)
    ...
    {231, "exit_group", 1, VOID, VOID, 0, 0, 0, 0, 0},
    ...
    {329, "pkey_mprotect", 4, NUM, CONST_VOID_P, NUM, NUM, NUM, 0, 0},
    {330, "pkey_alloc", 2, NUM, NUM, NUM, 0, 0, 0, 0},
    {331, "pkey_free", 1, NUM, NUM, 0, 0, 0, 0, 0},
    {332, "statx", 5, NUM, NUM, STRING, NUM, NUM, STRUCT_STATX_P, 0},
    {333, "io_pgetevents", 6, NUM, NUM, NUM, NUM, STRUCT_IO_EVENT_P,
    STRUCT_TIMESPEC_P, 0},
    {334, "rseq", 4, NUM, STRUCT_RSEQ_P, NUM, NUM, NUM, 0, 0},
    {335, "kexec_file_load", 5, NUM, NUM, NUM, NUM, STRING, NUM, 0},
    {336, "ioprio_set", 3, NUM, NUM, NUM, NUM, 0, 0, 0},
    {337, "ioprio_get", 2, NUM, NUM, NUM, 0, 0, 0, 0},
    {338, "migrate_pages", 4, NUM, NUM, NUM, CONST_UNSIGNED_P,
    CONST_UNSIGNED_P, 0, 0},
    {339, "openat2", 4, NUM, NUM, STRING, STRUCT_OPEN_HOW_P,
    CONST_UNSIGNED_P, 0, 0},
    {340, "pidfd_getfd", 2, NUM, NUM, NUM, 0, 0, 0, 0},
    {341, "faccessat2", 4, NUM, NUM, STRING, STRUCT_AT_FLAGS_P, NUM, 0, 0},
    {342, "process_madvise", 6, NUM, NUM, CONST_VOID_P, NUM, NUM, NUM, NUM},
    {343, "epoll_pwait2", 6, NUM, NUM, STRUCT_EPOLL_EVENT_P, NUM,
    STRUCT_SIGSET_T_P, CONST_UNSIGNED_P, 0},
    {344, "mount_setattr", 4, NUM, STRING, STRUCT_MOUNT_ATTR_P,
    CONST_UNSIGNED_P, NUM, 0, 0},
